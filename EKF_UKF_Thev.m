...
function [avr_err_EKF, std_err_EKF, avr_err_UKF, std_err_UKF] = EKF_UKF_Thev(SoC_upd_init, current)
    ...
    for T = 2 : N
        ...
        for t = (T-1) * ts/tr - (ts/tr - 2) : (T-1) * ts/tr + 1
            ...
            Rp = 4.1871+2.235 * SoC_real(1, t-1)^1 + 3.968 * SoC_real(1, t-1)^2 - 69.59 * SoC_real(1, t-1)^3 + 245.3 * SoC_real(1, t-1)^4 +401.1 * SoC_real(1,t-1)^5 + 317.3 * SoC_real(1, t-1)^6;
            Cp = 56.147 - 278.64 * SoC_real(1, t-1) + 6472.8 * SoC_real(1, t-1)^2 -51958 * SoC_real(1, t-1)^3 + 191077 * SoC_real(1, t-1)^4 - 349758 * SoC_real(1, t-1)^5 + 308738 * SoC_real(1, t-1)^6;
        ...
        UOC_real = -53.15* States_real(1, t)^7  + 216.8* States_real(1, t)^6  - 351.5* States_real(1, t)^5  + 285.4* States_real(1, t)^4  - 117.4* States_real(1, t)^3  + 20.61* States_real(1, t)^2  + 0.239*States_real(1, t) + 3.228;
        ...
        Rint_real=44.99 * States_real(1, t)^7  - 180 * States_real(1, t)^6  + 289.2 * States_real(1, t)^5  - 237.7 * States_real(1, t)^4  + 104.7 * States_real(1, t)^3  - 23.48 * States_real(1, t)^2  + 2.267 * States_real(1, t)^1  + 0.3916;
        ...
        Rp = 4.1871+2.235 * SoC_EKF(1, T-1)^1 + 3.968 * SoC_EKF(1, T-1)^2 - 69.59 * SoC_EKF(1, T-1)^3 + 245.3 * SoC_EKF(1, T-1)^4 +401.1 * SoC_EKF(1, T-1)^5 + 317.3 * SoC_EKF(1, T-1)^6;
        Cp = 56.147 - 278.64 * SoC_EKF(1, T-1)^1 + 6472.8 * SoC_EKF(1, T-1)^2 -51958 * SoC_EKF(1, T-1)^3 + 191077 * SoC_EKF(1, T-1)^4 - 349758 * SoC_EKF(1, T-1)^5 + 308738 * SoC_EKF(1, T-1)^6;     
